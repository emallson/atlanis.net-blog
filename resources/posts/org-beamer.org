...
* What is Org-mode?
  ...
  - Structured editing
    ...
    [[http://media.atlanis.net/blog/org-mode-screen.jpg]]
...
* Example Time!
  ...
  - Biographical Slide for Internship
    ...
    slide giving a brief biography. This was done [[http://media.atlanis.net/blog/ibm_bio_slide.org][as an Org document]]. The PDF
    output can be viewed [[http://media.atlanis.net/blog/org-beamer-example-output/ibm_bio_slide.pdf][here]]. This example demonstrates using columns and
    embedding images.
